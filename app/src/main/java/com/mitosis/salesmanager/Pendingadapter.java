...
TextView doconame,milez,tyetstarted,tstarted,treacheded ,tattened;
    ...
    public Pendingadapter(Context context, ArrayList<String> pcontactName, ArrayList<String> status, ArrayList<String> leadname,
        ...
        super(context, R.layout.pendingtab, pcontactName);
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        final View rowView = inflater.inflate(R.layout.pendingtab, parent, false);
